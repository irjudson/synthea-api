...
public class SyntheaAPI implements SparkApplication {
    ...
    public void init() {
        ...
        get("/api/hello", (request, response) -> "Hello, Synthea");

        get("/api/hello/:name", (request, response) -> {
        ...
        // Gson().toJsonTree(userService.getUsers())));
        // });
        ...
        // return new Gson().toJson(new StandardResponse(StatusResponse.SUCCESS, new
        // Gson().toJsonTree(userService.getUser(request.params(":id")))));
        // });
        ...
        // if (editedUser != null) {
        // return new Gson().toJson(new StandardResponse(StatusResponse.SUCCESS, new
        // Gson().toJsonTree(editedUser)));
        // } else {
        // return new Gson().toJson(new StandardResponse(StatusResponse.ERROR, new
        // Gson().toJson("User not found or error in edit")));
        // }
        // });
        ...
        // return new Gson().toJson(new StandardResponse(StatusResponse.SUCCESS,
        // (userService.userExist(request.params(":id"))) ? "User exists" : "User does
        // not exists"));
        // });
    }
}